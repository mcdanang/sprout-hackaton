      ...
      <div className="relative z-10 space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex -space-x-2">
            {project.team.slice(0, 3).map((avatar, i) => (
              <div key={i} className="h-8 w-8 rounded-full border-2 border-white overflow-hidden shadow-sm ring-1 ring-slate-100">
        ...
        <div className="flex items-center gap-6 pt-2 border-t border-slate-50 group-hover:border-slate-100 transition-colors">
          <div className="flex items-center gap-2 group/metric">
            ...
            <span className="text-sm font-bold font-plus-jakarta text-slate-700">{project.concernsCount}</span>
          </div>
          ...
          <div className="flex items-center gap-2 group/metric">
            ...
            <span className="text-sm font-bold font-plus-jakarta text-slate-700">{project.achievementsCount}</span>
          </div>
          ...
          <div className="flex items-center gap-2 group/metric">
            ...
            <span className="text-sm font-bold font-plus-jakarta text-slate-700">{project.kudosCount}</span>
          </div>
        </div>
      </div>
    </Link>
