				...
				<div className="mx-auto max-w-5xl">
					<div className="grid gap-12 md:grid-cols-3">
						<div className="space-y-4">
							...
							<p className="text-muted-foreground">{t("features.safe.description")}</p>
						</div>
						<div className="space-y-4">
							...
							<p className="text-muted-foreground">{t("features.peer.description")}</p>
						</div>
						<div className="space-y-4">
							...
							<p className="text-muted-foreground">{t("features.rapid.description")}</p>
						</div>
					</div>
				</div>
			</section>
